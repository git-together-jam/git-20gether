...
#region Beard Man
var _beardMan = ds_map_create();

// Base map
_beardMan[? "sprite"] = spr_beardman_mon;
_beardMan[? "name"] = "Beard Man";
_beardMan[? "leveling_curve"] = LevelingCurve.medium;
_beardMan[? "type"] = TwentymonType.earth;
...
ds_map_add_map(_beardMan, "base_stats", _base_stats);
ds_map_add_map(_beardMan, "stat_gains", _stat_gains);
...
#region Wax candle
var _candle = ds_map_create();

// Base map
_candle[? "sprite"] = spr_candle_mon;
_candle[? "name"] = "Wax Candle";
_candle[? "leveling_curve"] = LevelingCurve.medium;
_candle[? "type"] = TwentymonType.fire;
...
ds_map_add_map(_candle, "base_stats", _base_stats);
ds_map_add_map(_candle, "stat_gains", _stat_gains);

#endregion

#region Lil Flame Guy
var _flame = ds_map_create();

// Base map
_flame[? "sprite"] = spr_flame_mon;
_flame[? "name"] = "Lil Flame Guy";
...
ds_map_add_map(global.Twentymons, TwentymonId.beardMan, _beardMan);


ds_map_add_map(global.Twentymons, TwentymonId.candle, _candle);
